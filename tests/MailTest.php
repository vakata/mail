...
class StorageTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testFrom() {
		...
		$this->assertEquals($mail->setFrom('Name With a very long long Family so that it has to break into multiple header lines <test@asdf.com>')
			->getHeader('From'), "=?utf-8?B?TmFtZSBXaXRoIGEgdmVyeSBsb25nIGxvbmcgRmFtaWx5IHNvIHRoYQ==?=\r\n\t=?utf-8?B?dCBpdCBoYXMgdG8gYnJlYWsgaW50byBtdWx0aXBsZSBoZWFkZXIgbA==?=\r\n\t=?utf-8?B?aW5lcw==?= <test@asdf.com>");
